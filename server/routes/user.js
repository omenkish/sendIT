...
.get(Auth, Parcel.getCurrentUserParcels);

// router.get('/parcels/:id', Auth, Parcel.getUserParcelById)
router.get('/', Auth, Validator.adminOnly, User.getUsers);
router.get('/:id', Auth,  Validator.getById, User.getUserById)
router.patch('/:id/createadmin',Auth,Validator.adminOnly,Validator.getById, User.makeAdmin);
